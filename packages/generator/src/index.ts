 ...
 */
export async function generateInputType(schemaString: string, typeName: string = "Input"): Promise<string> {
	let schema;
	try {
 ...
 */
export function generateActorWrapper(actorName: string, actorId: string, inputTypeName: string): string {
 ...
 */
export async function generateActorCaller(schemaString: string, actorName: string, actorId: string): Promise<string> {
