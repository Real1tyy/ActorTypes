...
program
    ...
    .option('-i, --input <path>', 'Path to the TypeScript file containing the interface', path.join(process.cwd(), 'src/typedefs/input.ts'))
    .option('-o, --output <path>', 'Path to output the generated schema', path.join(process.cwd(), 'actor/input_schema.json'))
